...
class NewListViewUnitTest(unittest.TestCase):
    ...
    def test_passes_post_data_to_new_list_form(self, mock_list_class, mock_new_list_form):
        mock_list = mock_list_class.return_value
        mock_list.get_absolute_url.return_value = '/list/1'

        new_list_form = mock_new_list_form.return_value
        new_list_form.save.return_value = mock_list
        new_list(self.request)
        mock_new_list_form.assert_called_once_with(data=self.request.POST)

    @patch('lists.views.List')
    def test_saves_form_with_owner_if_form_valid(self, mock_list_class, mock_new_list_form):
        mock_list = mock_list_class.return_value
        mock_list.get_absolute_url.return_value = '/list/1'
